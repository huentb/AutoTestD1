...
public class UserCheckout {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (!productName.isEmpty() && price.startsWith("$")) {
                System.out.println("Tên và giá sản phẩm hợp lệ: " + productName + " - " + price);
            }
        }
